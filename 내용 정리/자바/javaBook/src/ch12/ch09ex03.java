...
public class ch09ex03 {
	...
	public static void main(String[] args) {
		 System.out.println("=== 연습문제 3: 다중 레벨 ===");
	        ...
	        Shape sp = new ColoredCircle();
	        sp.draw();
	        Circle Circlesp = (Circle)sp;
	        Circlesp.calculateArea();
	        ColoredCircle ColoredCirclesp = (ColoredCircle)Circlesp;
	        ColoredCirclesp.applyColor();
