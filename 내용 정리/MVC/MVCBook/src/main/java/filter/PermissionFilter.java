...
//						
		...
		pageGradeMap.put(projectPath+"/book/create", Role.ROLE_MANAGER); //2
		pageGradeMap.put(projectPath+"/book/update", Role.ROLE_MANAGER); //2
		pageGradeMap.put(projectPath+"/book/delete", Role.ROLE_MANAGER); //2
		
		pageGradeMap.put(projectPath+"/book/reply/create", Role.ROLE_ANONYMOUS); //0
		pageGradeMap.put(projectPath+"/book/reply/list", Role.ROLE_ANONYMOUS); //0
		
		// upload
		pageGradeMap.put(projectPath+"/file/upload",Role.ROLE_ANONYMOUS); //0
		pageGradeMap.put(projectPath+"/file/list",Role.ROLE_ANONYMOUS); //0
		pageGradeMap.put(projectPath+"/file/download",Role.ROLE_ANONYMOUS); //0
	}
