...
//		memoDaoImpl.insert(new MemoDto(1,"a","a",LocalDateTime.now(),null));
	...
	void test3() throws Exception {
		...
		PreparedStatement pstmt = con.prepareStatement("insert into tbl_book values('222','abcd','abcd','abcd')");	
		pstmt.executeUpdate();
	}
	...
	void test4() throws Exception {
		...
		PreparedStatement pstmt = con.prepareStatement("insert into tbl_book values('333','cba','cba','cba')");	
		pstmt.executeUpdate();
	}
}
